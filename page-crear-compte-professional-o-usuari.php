        ...
        <div class="CreateAccountUserOrProfessional-cards">
            <div class="CreateAccountUserOrProfessional-card">
                ...
                <div class="CreateAccountUserOrProfessional-cardText">
                    <a href="/registro-cliente" class="CreateAccountUserOrProfessional-cardBtn">Pedir un servicios</a>
            ...
            <div class="CreateAccountUserOrProfessional-card">
                ...
                <div class="CreateAccountUserOrProfessional-cardText">
                    <a href="/registro-proveedores" class="CreateAccountUserOrProfessional-cardBtn">Ofrecer servicios</a>
