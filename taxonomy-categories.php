	...
	<div class="Homecategories-content">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="firstrow">
              <a href="<?php echo home_url(); ?>/categories/llar" class="category">
              ...
              <a href="<?php echo home_url(); ?>/categories/apren" class="category">
              ...
              <a href="<?php echo home_url(); ?>/categories/esport" class="category">
              ...
              <a href="<?php echo home_url(); ?>/categories/ment" class="category">
          ...
          <div class="secondrow">
              <a href="<?php echo home_url(); ?>/categories/cuida_els_teus" class="category">
              ...
              <a href="<?php echo home_url(); ?>/categories/bellesa" class="category">
              ...
              <a href="<?php echo home_url(); ?>/categories/contracta" class="category">
              ...
              <a href="<?php echo home_url(); ?>/categories/comparteix" class="category">
              ...
              <a href="<?php echo home_url(); ?>/categories/esdeveniments" class="category">
