    ...
    <thead>
      <tr>
        <th class="product-remove"><span
            class="screen-reader-text"><?php esc_html_e( 'Elimina l\'element', 'woocommerce' ); ?></span></th>
        <th class="product-thumbnail"><span
            class="screen-reader-text"><?php esc_html_e( 'Imatge en miniatura', 'woocommerce' ); ?></span></th>
        <th class="product-name"><?php esc_html_e( 'Producte', 'woocommerce' ); ?></th>
        <th class="product-price"><?php esc_html_e( 'Preu', 'woocommerce' ); ?></th>
        <th class="product-quantity"><?php esc_html_e( 'Quantitat', 'woocommerce' ); ?></th>
      ...
      <tr>
        <td colspan="6" class="actions">
          ...
          <button type="submit"
            class="button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"
            name="update_cart"
            value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Actualitza el carretó', 'woocommerce' ); ?></button>
