  ...
  <div id="page" class="site">
    ...
    <header class="site-header header-desktop d-none d-md-block">
      ...
      <div class="container">
        <div class="row">
          <div class="col-2">
            <img class="image-fluid image header-logo-img"
          ...
          <div class="col-10 header-links">
            ...
            <div class="header-lang-wrapper dropdown">
              <button type="button" class="header-lang dropdown-toggle" id="header-lang-dropdown"
                data-bs-toggle="dropdown" aria-expanded="false">
                CA
                <img class="image-fluid header-lang-icon"
                  src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-chevron-down.png"
                  alt="lang chevron" />
              </button>
