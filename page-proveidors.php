      ...
      <div class="col-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Nom de servei</li>
          </ol>
        </nav>
      </div>
      <div class="col-12">
    ...
    <div class="row">
      <div class="col-12">
        <button class="btn-filtros">
          <img class="image-fluid image"
            src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-filter-icon.png" alt="ValeApp">
          <span class="text">Filtres</span>
        </button>
      </div>
      <div class="col-12">
        <div class="wrapper-text">
          <p>Ordenar per <span>Millor valorats</span></p>
          <img class="image" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-chevron-down.png"
            alt="ValeApp">
        </div>
      </div>
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="cards">
              ...
              <div class="card" id="modal01-button">
                <img class="img-fluid"
                  src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-card-image-v3.png"
                  alt="ValeApp">
                <div class="wrapper">
                  <p class="name"><?php echo get_user_meta($user->ID, 'first_name', true); ?></p>
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-star-image.png"
                    alt="ValeApp" class="star">
                  <p class="rate"><?php echo get_user_meta($user->ID, 'assessment', true); ?></p>
                </div>
                <span class="duration">3 mesos a Vale</span>
          ...
          <div class="swiper-slide">
            <div class="cards">
              <div class="card">
                <img class="img-fluid"
                  src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-card-image-v2.png"
                  alt="ValeApp">
                <div class="wrapper">
                  <p class="name">Maria</p>
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-star-image.png"
...
<section class="section4 pages" id="page4">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-section4.png"
          alt="ValeApp">
        <h3 class="title">
        ...
        <div class="content">
          <div class="wrapper">
            <img class="img-fluid image"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-section5-image1.jpg"
              alt="ValeApp">
...
<section class="section6 pages" id="page6">
  <div class="container">
    ...
    <div id="accordionfqa" class="accordion accordion-buttons">
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapsefaq"
            ...
            aria-controls="collapsefaq">¿Lorem ipsum dolor sit amet? <img class="img-fluid"
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapsefaq2"
            data-bs-toggle="collapse" data-bs-target="#collapsefaq2" aria-expanded="false" aria-controls="collapsefaq2">
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapsefaq3"
            ...
            aria-controls="collapsefaq3">¿Lorem ipsum dolor sit amet? <img class="img-fluid"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-chevron-faq.png"
              alt="ValeApp"></button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapsefaq4"
            ...
            aria-controls="collapsefaq4">¿Lorem ipsum dolor sit amet? <img class="img-fluid"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-chevron-faq.png"
              alt="ValeApp"></button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapsefaq5"
            data-bs-toggle="collapse" data-bs-target="#collapsefaq5" aria-expanded="false"
            aria-controls="collapsefaq5">¿Lorem ipsum dolor sit amet? <img class="img-fluid"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-chevron-faq.png"
              alt="ValeApp"></button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapsefaq6"
            data-bs-toggle="collapse" data-bs-target="#collapsefaq6" aria-expanded="false"
            aria-controls="collapsefaq6">¿Lorem ipsum dolor sit amet? <img class="img-fluid"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-chevron-faq.png"
              alt="ValeApp"></button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapsefaq7"
            data-bs-toggle="collapse" data-bs-target="#collapsefaq7" aria-expanded="false"
            aria-controls="collapsefaq7">¿Lorem ipsum dolor sit amet? <img class="img-fluid"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-chevron-faq.png"
              alt="ValeApp"></button>
        </h2>
...
<section class="section7 pages" id="page7">
  <div class="container">
    ...
    <div id="accordionCategories" class="accordion accordion-buttons">
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseHome"
            data-bs-toggle="collapse" data-bs-target="#collapseHome" aria-expanded="false" aria-controls="collapseHome">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category1.png"
              alt="ValeApp">
            Hogar
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseLearn"
            data-bs-toggle="collapse" data-bs-target="#collapseLearn" aria-expanded="false"
            aria-controls="collapseLearn">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category2.png"
              alt="ValeApp">
            Aprende
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseBody"
            data-bs-toggle="collapse" data-bs-target="#collapseBody" aria-expanded="false" aria-controls="collapseBody">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category3.png"
              alt="ValeApp">
            Deporte
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseMind"
            data-bs-toggle="collapse" data-bs-target="#collapseMind" aria-expanded="false" aria-controls="collapseMind">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category4.png"
              alt="ValeApp">
            Mente
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseTakeCare"
            data-bs-toggle="collapse" data-bs-target="#collapseTakeCare" aria-expanded="false"
            aria-controls="collapseTakeCare">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category5.png"
              alt="ValeApp">
            Cuida de los tuyos
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseBeauty"
            data-bs-toggle="collapse" data-bs-target="#collapseBeauty" aria-expanded="false"
            aria-controls="collapseBeauty">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category6.png"
              alt="ValeApp">
            Belleza
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseContract"
            data-bs-toggle="collapse" data-bs-target="#collapseContract" aria-expanded="false"
            aria-controls="collapseContract">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category7.png"
              alt="ValeApp">
            Contrata
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseRent"
            data-bs-toggle="collapse" data-bs-target="#collapseRent" aria-expanded="false" aria-controls="collapseRent">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category8.png"
              alt="ValeApp">
            Alquila
          </button>
        </h2>
      ...
      <div class="accordion-item">
        <h2 id="headingPoints" class="accordion-header">
          <button type="button" class="accordion-button event collapsed" data-label="collapseOther"
            data-bs-toggle="collapse" data-bs-target="#collapseOther" aria-expanded="false"
            aria-controls="collapseOther">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-category9.png"
              alt="ValeApp">
            Otros
          </button>
        </h2>
...
<div id="modal01" class="modals" style="position: fixed; z-index: 9001; display: none;">
  <div class="content">
    ...
    <div class="wrapper">
      <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-card-image-v3.png"
        alt="ValeApp">
    ...
    <div class="wrapper2">
      ...
      <div id="gallery" class="swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img class="img-fluid gallery"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-gallery.jpg" alt="ValeApp">
            <img class="img-fluid gallery"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-gallery.jpg" alt="ValeApp">
            <img class="img-fluid gallery"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-gallery.jpg" alt="ValeApp">
      ...
      <div class="rating-content">
        <div class="rating-wrapper">
          <img class="img-fluid profile"
            src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-rating-photo.png" alt="ValeApp">
          <div class="rating-info">
            <p class="name">Jorge P</p>
            <img class="img-fluid"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-rating-modal.png" alt="ValeApp">
          </div>
    ...
    <div class="wrapper5">
      ...
      <div class="wrapper">
        ...
        <img class="img-fluid"
          src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-card-image-v3.png" alt="ValeApp">
      </div>
      <button class="btn">
        <img class="img-fluid message"
          src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-message-icon.png" alt="ValeApp">
    ...
    <div class="wrapper7">
      ...
      <div class="content">
        <img class="service" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-service1.jpg"
          alt="ValeApp">
        <div class="block">
          <div class="info">
            <img class="profile"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-ervice-user.png" alt="ValeApp">
            <span class="name"><?php echo get_post_meta($post->ID, 'name', true); ?></span>
          </div>
          <div class="info">
            <img class="icon" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-service-icon.png"
              alt="ValeApp">
      ...
      <div class="content">
        <img class="service" src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-service2.jpg"
          alt="ValeApp">
        <div class="block">
          <div class="info">
            <img class="profile"
          ...
          <div class="info">
            <img class="icon"
              src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-providers-service-icon2.png" alt="ValeApp">
