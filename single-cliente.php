      ...
      <nav class="menu">
        <ul class="list">
          <a class="link" href="/editar-datos-de-usuario">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-account-icon.png" alt="ValeApp"
                class="img-fluid option-icon">
              <span class="option-text">Compte i dades personals</span>
            </li>
          </a>
          <a class="link" href="/solicitar-servei">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-catalogue-icon.png" alt="ValeApp"
                class="img-fluid option-icon">
          ...
          <a class="link" href="/solicituds">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-requests-icon.png" alt="ValeApp"
                class="img-fluid option-icon">
          ...
          <a class="link" href="/les-meves-ofertes">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-task-icon.png" alt="ValeApp"
                class="img-fluid option-icon">
          ...
          <a class="link" href="/tasques-contractades">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-contracted-tasks-icon.png"
                alt="ValeApp" class="img-fluid option-icon">
              <span class="option-text">Tasques Contractades</span>
            </li>
          </a>
          <a class="link" href="/el-meu-saldo-client">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-balance-icon.png" alt="ValeApp"
                class="img-fluid option-icon">
          ...
          <a class="link" href="/missatgeria">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-messages-icon.png" alt="ValeApp"
                class="img-fluid option-icon">
          ...
          <a class="link" href="/promocions">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-promotion-icon.png" alt="ValeApp"
                class="img-fluid option-icon promotions">
          ...
          <a class="link" href="">
            <li class="option">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-help-icon.png" alt="ValeApp"
                class="img-fluid option-icon">
