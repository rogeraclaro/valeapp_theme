...
<div class="cards">
  <div class="cards-title">
    A continuació trobaràs els professionals que millor s'adapten a la teva cerca.
  </div>
    ...
    <div class="cards-item">
      <div class="cards-item-content">
        <div class="cards-item-img">
          ...
          <img class="cards-item-imgIcon"
            src="<?php echo get_stylesheet_directory_uri(); ?>/img/valeapp-profile-check.png" alt="ValeApp-Check">
        </div>
